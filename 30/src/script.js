    ...
    */
    material = new THREE.ShaderMaterial({
        ...
        uniforms: {
            ...
            uTime: { value: 0 },
            uSpeed: { value: view.rotationSpeed }
        }
    })
...
const randomValues = () => {
    ...
    view.rotationSpeed = gsap.utils.random(0.1, 0.7) * gsap.utils.random([1, -1])
...
const updateAutoGenerate = () => {
    ...
    {
        autoGenerateTimer = setInterval(randomValues, gsap.utils.random([15 * 1000, 20 * 1000, 30 * 1000, 45 * 1000]))
    }
}
...
previewTab.addBinding(view, 'rotationSpeed', { label: 'Spin speed', min: -0.7, max: 0.7, step: 0.01 })
...
const tick = () =>
{
    ...
    if (material !== null) {
        ...
        material.uniforms.uSpeed.value = view.rotationSpeed
    }
